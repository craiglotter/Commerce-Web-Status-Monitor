...
#Region " Windows Form Designer generated code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.Label5.Text = "Number of IISReset Calls:"
        '
        'Label3
        '
        ...
        Me.Label4.Text = "Web Status Monitor"
        ...
        Me.Text = "Commerce Web Status Monitor"
...
#End Region
    ...
    Private Sub Timer1_Tick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Timer1.Tick
        Try
            ...
            If error_encounter = True Then
                ...
                ProcID = Shell("iisreset /restart", AppWinStyle.Hide, True, 30000)
                Label11.Text = Double.Parse(Label11.Text) + 1
                Label12.Text = Now()
                Try
                    Dim body As String
                    body = "The webserver hosting """ & url & """ has reported a serious system error as of " & Now() & ". Action has been taken to restart the web server. The number of recorded errors such as this currently stands at " & Label11.Text & "."
                    body = body & vbCrLf & vbCrLf & "This is an auto-generated email submitted from Commerce Web Status Monitor 1.0"
                    TextMail(email, "IISReset Triggered", body)
                Catch ex As Exception
    ...
    Private Sub MenuItem3_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MenuItem3.Click
        Try
            ...
            Application.Exit()
        Catch ex As Exception
            Error_Handler("An """ & ex.Message & """ error occurred while closing Commerce Web Status Monitor. The program will attempt to recover shortly.")
        End Try
    End Sub
